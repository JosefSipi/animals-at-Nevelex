...
class AnimalShow extends React.Component {
  ...
  async deleteClicked() {
    ...
    const retStatus = await fetch(
      `https://animalrestapi.azurewebsites.net/Animal/Delete/?candidateID=cc716bca-578b-4ea3-935b-4cabac7f9696&id=${this.state.animal_id}`,
      requestOptions
    );
  ...
  async fetchEntry(id) {
    ...
    const retValData = await fetch(
      `https://animalrestapi.azurewebsites.net/Animal/Id?candidateID=cc716bca-578b-4ea3-935b-4cabac7f9696&id=${id}`,
      requestOptions
    );
      ...
      <div className="modal-div-main">
        ...
        <div className="show-modal-txt">
          ...
          <button
            ...
            onClick={() => this.setState({ confirmDelet: true })}
          >
            {" "}
            Delete Animal{" "}
          </button>
          ...
          <div className="parent-delet">
            <div className="delete-confirm">
              ...
              <div className="delete-buttons">
                ...
                <button onClick={() => this.setState({ confirmDelet: false })}>
                  Cancel
                </button>
              </div>
            </div>
